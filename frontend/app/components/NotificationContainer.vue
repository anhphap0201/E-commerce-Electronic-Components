<template>
  <div class="fixed top-18 right-4 z-[9999] flex flex-col gap-3 max-w-sm w-full pointer-events-none">
    <TransitionGroup
    ...
    >
      <div
        ...
        :key="notification.id"
        :class="[
          'pointer-events-auto rounded-xl shadow-lg p-4 flex items-start gap-3 backdrop-blur-sm',
